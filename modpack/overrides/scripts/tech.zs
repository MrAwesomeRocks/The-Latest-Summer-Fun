...
<recipetype:thermal:lapidary_fuel>.addFuel("certus_fuel", <tag:items:forge:gems/certus_quartz>, 40000);
<recipetype:thermal:lapidary_fuel>.addFuel("fluix_fuel", <tag:items:forge:gems/fluix>, 100000);
...
// ---------------------------------------------------------------------------------------------------------------------------------------------
<recipetype:create:crushing>.addRecipe("cryptic_redstone_crushing", [<tag:items:forge:dusts/redstone> * 8 % 100, <tag:items:forge:dusts/redstone> * 6 % 25, <item:byg:cryptic_stone> % 12], <item:byg:cryptic_redstone_ore>);
...
<recipetype:thermal:pulverizer>.addRecipe("pervaded_pulverizer", [<tag:items:forge:dusts/glowstone> * 6 % 150, <tag:items:forge:gems/sulfur> % 25] , <item:byg:pervaded_netherrack>, 2, 4000);
<recipetype:thermal:smelter>.addRecipe("pervaded_smelter", [<tag:items:forge:dusts/glowstone> * 3 % 150, <tag:items:forge:gems/sulfur> % 50, <item:thermal:rich_slag> % 15], [<item:byg:pervaded_netherrack>], 2, 3200);
<recipetype:immersiveengineering:crusher>.addRecipe("pervaded_crusher", <item:byg:pervaded_netherrack>, 6000, <tag:items:forge:dusts/glowstone> * 6, <tag:items:forge:gems/sulfur_dust> % 25);
<recipetype:create:crushing>.addRecipe("pervaded_crushing", [<tag:items:forge:dusts/glowstone> * 8 % 100, <tag:items:forge:dusts/glowstone> * 6 % 25, <item:byg:cryptic_stone> % 12], <item:byg:pervaded_netherrack>);

furnace.addRecipe("liginite_furnace", <item:byg:lignite>, <item:byg:lignite_ore>, 0.5, 200);
<recipetype:thermal:pulverizer>.addRecipe("liginite_pulverizer", [<item:byg:lignite> * 6 % 150, <tag:items:forge:gems/sulfur> % 15, <item:minecraft:gravel> % 20] , <item:byg:lignite_ore>, 2, 4000);
...
<recipetype:immersiveengineering:crusher>.addRecipe("liginite_crusher", <item:byg:lignite_ore>, 6000, <item:byg:lignite> * 6, <tag:items:forge:gems/sulfur_dust> % 15);
...
<recipetype:thermal:pulverizer>.addRecipe("anthracite_pulverizer", [<item:byg:anthracite> * 2 % 150, <tag:items:forge:gems/sulfur> % 15, <item:minecraft:gravel> % 20] , <item:byg:anthracite_ore>, 2, 4000);
...
<recipetype:immersiveengineering:crusher>.addRecipe("anthracite_crusher", <item:byg:anthracite_ore>, 6000, <item:byg:anthracite> * 2, <tag:items:forge:gems/sulfur_dust> % 15);
...
<recipetype:thermal:smelter>.addRecipe("fiery_glass_smelter", [<item:druidcraft:fiery_glass> * 3 % 150, <itetag:items:forge:gems/cinnabar> % 50, <item:thermal:rich_slag> % 15], [<item:druidcraft:fiery_glass_ore>], 2, 3200);
...
<recipetype:thermal:smelter>.addRecipe("yellorium_smelter", [<tag:items:forge:ingots/uranium>, <item:thermal:rich_slag> % 15], [<item:tag:items:forge:ores/uranium>], 2, 3200);
<recipetype:immersiveengineering:crusher>.addRecipe("yellorium_crusher", <item:tag:items:forge:ores/uranium>, 6000, <item:tag:items:forge:dusts/uranium> * 2);
<recipetype:create:crushing>.addRecipe("yellorium_crushing", [<item:tag:items:forge:dusts/uranium> % 100, <item:tag:items:forge:dusts/uranium> * 2 % 30, <item:minecraft:cobblestone> % 12], <item:tag:items:forge:ores/uranium>);
...
<recipetype:thermal:pulverizer>.addRecipe("certus_pulverizer", [<tag:items:forge:gems/certus_quartz> * 2 % 50, <tag:items:forge:dusts/certus_quartz> % 15, <item:minecraft:gravel> % 20] , <tag:items:forge:ores/certus_quartz>, 2, 4000);
<recipetype:thermal:smelter>.addRecipe("certus_smelter", [<tag:items:forge:gems/certus_quartz> % 150, <item:thermal:rich_slag> % 15], [<tag:items:forge:ores/certus_quartz>], 2, 3200);
<recipetype:immersiveengineering:crusher>.addRecipe("certus_crusher", <tag:items:forge:ores/certus_quartz>, 6000, <tag:items:forge:gems/certus_quartz> * 3, <item:minecraft:cobblestone> % 25);

<recipetype:thermal:pulverizer>.addRecipe("charged_certus_pulverizer", [<tag:items:forge:gems/charged_certus_quartz> * 2 % 50, <tag:items:forge:dusts/certus_quartz> % 15, <item:minecraft:gravel> % 20] , <tag:items:forge:ores/charged_certus_quartz>, 2, 4000);
<recipetype:thermal:smelter>.addRecipe("charged_certus_smelter", [<tag:items:forge:gems/charged_certus_quartz> % 150, <item:thermal:rich_slag> % 15], [<tag:items:forge:ores/charged_certus_quartz>], 2, 3200);
<recipetype:immersiveengineering:crusher>.addRecipe("charged_certus_crusher", <tag:items:forge:ores/charged_certus_quartz>, 6000, <tag:items:forge:gems/charged_certus_quartz> * 3, <item:minecraft:cobblestone> % 25);
...
// ---------------------------------------------------------------------------------------------------------------------------------------------
<recipetype:create:compacting>.addRecipe("electrum_compression_create", "none", <tag:items:forge:ingots/electrum>, [<tag:items:forge:nuggets/electrum> * 9], [], 100);
<recipetype:create:compacting>.addRecipe("constantan_compression_create", "none", <tag:items:forge:ingots/constantan>, [<tag:items:forge:nuggets/constantan> * 9], [], 100);
<recipetype:create:compacting>.addRecipe("nickel_compression_create", "none", <tag:items:forge:ingots/nickel>, [<tag:items:forge:nuggets/nickel> * 9], [], 100);
<recipetype:create:compacting>.addRecipe("aluminum_compression_create", "none", <tag:items:forge:ingots/aluminum>, [<tag:items:forge:nuggets/aluminum> * 9], [], 100);
// ---------------------------------------------------------------------------------------------------------------------------------------------
