...
<item:simplyjetpacks:jetpack_te5>.addTooltip("Temporary Crafting Recipe.");
<item:simplyjetpacks:thruster_te5>.addTooltip("Temporary Crafting Recipe.");

<item:contenttweaker:sandwich_blt>.addTooltip("What do you mean it isn't 'bacon leaves tomato'?");
